...
{
    // daha küçük türlerin daha büyük türlere terfisidir (short'tan int'e gibi).
    // predefined unary ve binary numeric operatorlerinin operandları için uygulanır.
    //sayısal terfi(numeric promotion) işlemleri, belirli bilinçsiz dönüşümlerin operatörlerin operandlarına uygulanmasıdır.
    ...
    /* predefined implementations of the binary * operator:
